...
Плагин позволяет синхронизировать и отображать локальные параметры профиля (Telegram Premium, цвет имени и ответов, цвет обложки, анимированные эмодзи-статусы и фоновые узоры) между пользователями на вашем собственном приватном сервере.
...
3. Перейдите в *Настройки -> Плагины -> SyncProfile*:
   ...
   - Настройте цвета, узоры и нажмите **«🚀 Опубликовать профиль»**.
