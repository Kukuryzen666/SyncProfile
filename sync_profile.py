...
NAME_AND_REPLY_COLORS = [
    # Ряд 1: Однотонные цвета (7) - Порядок строго как в официальном Telegram
    "0 - 🔴 Красный",
    "1 - 🟠 Оранжевый",
    "2 - 🟣 Фиолетовый",
    "3 - 🟢 Зеленый",
...
PROFILE_COLORS = list(NAME_AND_REPLY_COLORS)
...
PEER_COLOR_RGB_MAP = {
    ...
    7: -306606,    # 7: 🔴/🟠 Красный + Оранжевый
    8: -27392,     # 8: 🟠/🟡 Оранжевый + Желтый
    9: -5745161,   # 9: 🟣/🌸 Фиолетовый + Розовый
    10: -11870592, # 10: 🟢/🌊 Зеленый + Бирюзовый
    11: -14494738, # 11: 🌊/🔵 Бирюзовый + Синий
    12: -10443270, # 12: 🔵/🟣 Синий + Фиолетовый
    13: -757066,   # 13: 🌸/🔴 Розовый + Красный

    14: -306606,   # 14: 🔴/🟠/🟡 Красный + Оранжевый + Желтый
    15: -27392,    # 15: 🟠/🟡/🟢 Оранжевый + Желтый + Зеленый
    16: -5745161,  # 16: 🟣/🌸/🔴 Фиолетовый + Розовый + Красный
    17: -11870592, # 17: 🟢/🌊/🔵 Зеленый + Бирюзовый + Синий
    18: -14494738, # 18: 🌊/🔵/🟣 Бирюзовый + Синий + Фиолетовый
    19: -10443270, # 19: 🔵/🟣/🌸 Синий + Фиолетовый + Розовый
    20: -757066,   # 20: 🌸/🔴/🟠 Розовый + Красный + Оранжевый
}
    ...
    def _resolve_profile_color_id_for_user(self, user_or_uid: Any) -> int:
        ...
        if uid > 0:
            ...
            if prof and "profile_color" in prof:
                return _safe_int(prof.get("profile_color"), 0)
            try:
                from org.telegram.messenger import UserConfig
                max_accs = getattr(UserConfig, "MAX_ACCOUNT_COUNT", 4)
                for a in range(max_accs):
                    u_c = UserConfig.getInstance(a)
                    if u_c and int(u_c.getClientUserId() or 0) == uid:
                        return _safe_int(self._get_slot_val(a, "profile_color", 0), 0)
            except Exception:
                pass
